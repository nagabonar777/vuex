...
<div class="grid grid-cols-4 gap-4 ">
    ...
    <a href="#">
        <img class="p-2 rounded-t-lg object-scale-down h-48 w-97 " :src="product.image"  alt="product image" />
    </a>
    <div class="mt-4 px-5 pb-5 ">
        ...
        <div class="flex items-center justify-between">
            ...
            <router-link :to="{name: 'SingleProduct', params: {id: product.id}}" class=" group text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Check Out</router-link>
        </div>
    </div>
  </div>
</div>
...
export default {
    ...
    methods: {
        ...mapActions("product", ["fetchProductCategory"]),
    },
    created() {
